...
def MobileNetV3(type="large", input_shape=(224, 224, 3), classes_number=30, width_multiplier=1.0, divisible_by=8, l2_reg=2e-5, dropout_rate=0.2, name="MobileNetV3", plot_model=False):
    ...
    outputs = tf.keras.layers.Reshape((classes_number,), name='output')(output)
